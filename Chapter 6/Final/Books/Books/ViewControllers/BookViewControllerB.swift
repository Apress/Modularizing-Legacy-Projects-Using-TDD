...
class BookViewControllerB: UIViewController {
    ...
    @IBAction func addCurrentBookToFavorites() {
        // add to favorites
        saveBookAsFavorite(withBook: self.book!)
    }
...
extension BookViewControllerB {
    ...
    func saveBookAsFavorite(withBook bookModel:BookModel) {
        ...
        let book = Book(context: appDelegate.persistentContainer.viewContext)
        configure(book: book, usingBookModel: bookModel)
    ...
    func configure(book:Book, usingBookModel model:BookModel ) {
        ...
        for buyLink in buyLinks {
            let appDelegate = UIApplication.shared.delegate as! AppDelegate
            let link = BuyLink(context: appDelegate.persistentContainer.viewContext)
